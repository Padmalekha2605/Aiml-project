...
Original file is located at
    https://colab.research.google.com/drive/14KOgyrwJzO7meKmelKk8IFfM5_i_3_KF
"""
...
def sentiment(label):
    if label < 0:
        ...
        return "Neutral" # This line was missing, causing the IndentationError
    elif label > 0:
        return "Positive"
...
# Remove 'kernel', 'degree', and 'gamma' from the grid
grid = {
    'C': [0.01, 0.1, 1, 10],
    # 'kernel': ["linear", "poly", "rbf", "sigmoid"],  # Remove this line
    # 'degree': [1, 3, 5, 7],  # Remove this line
    # 'gamma': [0.01, 1]  # Remove this line
}

grid = GridSearchCV(SVCmodel, param_grid=grid)
grid.fit(x_train, y_train)
